...
- (void)presentPopupViewController:(UIViewController*)popupViewController animationType:(MJPopupViewAnimation)animationType position:(CGPoint)posion;
{
...
//    CGSize sourceSize = sourceView.bounds.size;
    CGSize popupSize = popupView.bounds.size;
    CGRect popupEndRect = CGRectMake(0,//(sourceSize.width - popupSize.width) / 2,
                                     90,//(sourceSize.height - popupSize.height) / 2,
                                     popupSize.width, 
                                     popupSize.height);
