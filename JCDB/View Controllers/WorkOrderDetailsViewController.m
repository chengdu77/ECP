...
- (UIView *)addViewFrame:(CGRect)frame tag:(int)tag bean:(FormFieldsBean *)bean fieldType:(NSString *)fieldType {
     ...
     - (void)initAddButton{
         ...
         //    favoriteButton.frame = CGRectMake(10,self.viewHeight-50, 40, 40);
         //
         //    [favoriteButton setTitle:@"关注" forState:UIControlStateNormal];
         //    [favoriteButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
         //    favoriteButton.backgroundColor = kALLBUTTON_COLOR;
         //    favoriteButton.titleLabel.font = [UIFont fontWithName:kFontName size:14];
         //
         //    favoriteButton.layer.borderWidth = 1;
         //    favoriteButton.layer.borderColor = kALLBUTTON_COLOR.CGColor;
         //    favoriteButton.layer.cornerRadius = favoriteButton.bounds.size.width/2;
         //
         //    favoriteButton.layer.shadowColor=[UIColor blackColor].CGColor;
         //    favoriteButton.layer.shadowOffset=CGSizeMake(1, 1);
         //    favoriteButton.layer.shadowOpacity=0.5;
         //    favoriteButton.layer.shadowRadius=1;
         //
